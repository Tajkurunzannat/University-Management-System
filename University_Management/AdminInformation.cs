        ...
        private void saveBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    conn.Open();
                    string query = "";
                    query = "INSERT INTO AdminInfo (AdminName,AdminPass,DOB,Email,UserType) VALUES('" + txtName.Text + "','" + txtPass.Text + "','" + dtpDOB.Text + "','" + txtEmail.Text + "','" + ddlUType.Text + "')";
        ...
        private void deleteBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlConnection conn = new SqlConnection(@"Server=ABIRRIFAT\SQLEXPRESS;Database=UM_database;Integrated Security=true");
                    string query = "";
                    query = "DELETE  FROM AdminInfo Where ID='" + this.txtID.Text + "';";
                    SqlCommand cmd = new SqlCommand(query, conn);
