...
namespace University_Management
{
    public partial class AdminStudentInfo : Form
    {
        ...
        public AdminStudentInfo(string username)
        {
            InitializeComponent();
        ...
        private void saveBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    conn.Open();
                    string query = "";
                    query = "INSERT INTO StudentInf (StudentName,StudentPass,DOB,Email,UserType) VALUES('" + txtName.Text + "','" + txtPass.Text + "','" + dtpDOB.Text + "','" + txtEmail.Text + "','" + ddlUType.Text + "')";
        ...
        private void viewBtn_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            //string query = "";
            String query = "SELECT * FROM StudentInf";
            SqlDataAdapter sda = new SqlDataAdapter(query, conn);
            DataTable da = new DataTable();
            sda.Fill(da);
            dGvstudent.DataSource = da;
            conn.Close();
        }
        ...
        private void deleteBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlConnection conn = new SqlConnection(@"Server=ABIRRIFAT\SQLEXPRESS;Database=UM_database;Integrated Security=true");
                    string query = "";
                    query = "DELETE  FROM StudentInf Where ID='" + this.txtID.Text + "';";
                    SqlCommand cmd = new SqlCommand(query, conn);
